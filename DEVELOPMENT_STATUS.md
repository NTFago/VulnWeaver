...
- **当前分支**：`docs/adr-021-accept`，基于 `main@b704814` 创建，用于登记 ADR-021 评审结论；PR #17 已合并入 `main`。
- **当前负责人**：Codex。当前仅登记 ADR-021 已接受状态，不修改生产代码；T20/T21/T22 的真实回放与最终验收，以及 T16/T18/T19 的工具链验收事项保持不变。
