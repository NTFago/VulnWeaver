...
- **最后更新**：2026-09-09 21:52（Asia/Shanghai）
...
| M16 报告与结果交换 | 进行中 | Codex | 新增 `vulnweaver-reporting` 包和有界 SARIF 2.1.0 生成器，保留 Finding ID、CWE、位置、状态与置信度，不嵌入原始日志 | 补充 Markdown/PDF 模板、SARIF Schema 校验和派生工件登记 | 2026-09-09 |
