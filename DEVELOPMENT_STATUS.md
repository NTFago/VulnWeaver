...
- **最后更新**：2026-09-09 22:16（Asia/Shanghai）
...
| M16 报告与结果交换 | 进行中 | Codex | 新增 `vulnweaver-reporting` 包、有界 SARIF 2.1.0 生成器和 Markdown 报告渲染器，保留 Finding、证据/复核/POC 引用及限制说明，不嵌入原始日志 | 补充 PDF 模板、SARIF Schema 校验和派生工件登记 | 2026-09-09 |
