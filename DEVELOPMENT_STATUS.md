...
- **最后更新**：2026-09-09 23:24（Asia/Shanghai）
...
| M16 报告与结果交换 | 进行中 | Codex | 新增 `vulnweaver-reporting` 包、有界 SARIF 2.1.0 生成器、Markdown 报告渲染器、转 PDF 用安全 HTML 源和 SARIF 2.1.0 信封校验，保留 Finding、证据/复核/POC 引用及限制说明，不嵌入原始日志；报告测试已补齐 | 在镜像声明并安装 PDF 引擎后补 PDF 模板、完整 SARIF Schema 校验和派生工件登记 | 2026-09-09 |
