...
- **最后更新**：2026-09-10 00:12（Asia/Shanghai）
...
| M16 报告与结果交换 | 进行中 | Codex | 新增 `vulnweaver-reporting` 包、有界 SARIF 2.1.0 生成器、Markdown 报告渲染器、转 PDF 用安全 HTML 源、WeasyPrint PDF 渲染和 SARIF 2.1.0 信封校验；Dev Container 已维护 PDF 系统库和固定 Python 依赖；报告测试已补齐 | 补充完整 SARIF Schema 校验和派生工件登记 | 2026-09-10 |
