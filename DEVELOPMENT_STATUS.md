...
| T37 Markdown 快速路径 CI 修复 | 进行中 | Codex（`ci/markdown-gate-base-fetch`） | Q-017 登记；`quality-gate.yml` Markdown gate 在 diff 前浅取 base 提交 | 修复 PR 全量门禁通过后合并，再以 markdown-only PR 实跑验证快速路径后转「已完成」 | 2026-09-11 |
